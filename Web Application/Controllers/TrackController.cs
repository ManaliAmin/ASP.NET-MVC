...
namespace Assign9.Controllers
{
    public class TrackController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            {
                var form = m.mapper.Map<TrackWithDetail, TrackEditForm>(o);
        ...
        public ActionResult Edit(int? id, TrackEdit newItem)
        {
            ...
            editedItem.AudioUpload = newItem.AudioUpload;
            if (editedItem == null)
            {
                return View(newItem);
            }
            ...
            {
                return RedirectToAction("../Track/Details", new { id = editedItem.Id });
            }
        }
